...
-- Draft-day production hotfix.
-- The seven-day option window remains mandatory when at least one
-- eligible owner option exists. A canonical zero-option population
-- may proceed immediately because no owner decision is outstanding.
