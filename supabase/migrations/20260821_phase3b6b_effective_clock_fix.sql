...
-- Phase 3B.6B corrective migration:
-- execution-time option-window validation must use the same
-- disposable/test-aware authoritative clock as the lifecycle RPCs.
